...
\begin{enumerate}
  ...
  \item เอ็นเอฟซีการ์ดอีมูเลชั่น (NFC Card Emulation Mode) โหมดนี้จะทำงานเสมือนเป็นบัตร Contactless ซึ่งนั่นหมายความว่าอุปกรณ์มือถือตามมาตรฐานเอ็นเอฟซีจะทำตัวเป็นบัตร Contactless Smart Card เพื่อใช้ในการทำธุรกรรมต่าง ๆ ได้
...
ผลงานวิจัย \ref{itm:IDA-Pay} ได้นำเสนอระบบต้นแบบสำหรับการชำระเงินที่มีความปลอดภัยบนเทคโนโลยีเนียร์ฟิลด์คอมมูนิเคชันด้วยแอนดรอยด์แพลตฟอร์ม ใช้ระบบการแลกเปลี่ยนข้อมูลแบบเพียร์ทูเพียร์ ซึ่งข้อมูลที่ถูกส่งไปยังณ จุดขาย ข้อมูลจะถูกทำการเข้ารหัสแบบกุญแจสาธารณะ (Public key) เพื่อรับประกันความปลอดภัยของข้อมูล
...
\subsection{การวิเคราะห์และออกแบบระบบต้นแบบ}
เพื่อการออกแบบหน้าที่พื้นฐานของการทํางานระบบต้นแบบเพื่อสนับสนุนระบบต้นแบบ จึงใช้แนวความคิดเชิงวัตถุ (Object-Oriented Paradigm) ในการวิเคราะห์และออกแบบ โดยใช้แผนภาพยูสเคส และแผนภาพกิจกรรมแสดงหน้าที่การทํางานของระบบต้นแบบ
...
เพื่อแสดงโครงสร้าง และองค์ประกอบของหน้าจอการทํางานที่จะปรากฏในระบบต้นแบบ รวมถึงข้อความที่ใช้แสดงเตือนหรือแสดงความผิดพลาด และข้อความช่วยเหลือผู้ใช้งาน โดยแสดงเป็นภาพต้นแบบ
